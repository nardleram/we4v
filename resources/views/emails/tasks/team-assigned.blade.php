...
<p>{{ $user->username }} assigned a task to “<em>{{ $task->taskable->name }}</em>”, a team you are in. This task belongs to the project, “<em>{{ $task->project->name }}</em>”</p>
...
<p>If you would like to respond, go to <a href="{{ route('talkboard') }}">we4v</a>, click the “Assigned tasks” panel on the right of each we4v page, and then click the relevant task.</p>
