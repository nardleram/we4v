...
<div class="mx-auto mt-20 text-center">
    ...
    <h2 class="text-we4vGrey-500 text-3xl font-bold">Group not found</h2>
    <h3 class="text-we4vGrey-500 text-lg">Apologies. There was an internal server error resulting from a query to retrieve your groups from the database. Please try again later. If the problem persists, contact one of our admins.</h3>
