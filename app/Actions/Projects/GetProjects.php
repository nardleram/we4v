...
class GetProjects
{
    ...
    public function handle($userId)
    {
        $rawProjects = DB::select("SELECT 
            ...
            Pr1.team_id as project_team_id,
            Te2.name as project_team_name,
            ...
            Te1.name as project_task_team,
            Te1.id as project_task_team_id,
            ...
            Us4.id as team_member_user_id,
            Me2.confirmed as team_member_confirmed,
            Me3.created_at as task_member_created_at
        FROM projects Pr1
        ...
        ON Us1.id = No1.user_id
        LEFT OUTER JOIN users Us2
        ON Us2.id = No2.user_id
        ...
        LEFT OUTER JOIN memberships Me3
        ON Me3.membershipable_id = Ta1.id
        LEFT OUTER JOIN users Us3
        ON Us3.id = Me3.user_id
        LEFT OUTER JOIN groups Gr2
        ON Gr2.id = Pr1.group_id
        LEFT OUTER JOIN teams Te2
        ON Te2.id = Pr1.team_id
